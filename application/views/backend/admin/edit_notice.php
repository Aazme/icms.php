                            ...
                            <div class="col-sm-7">
                                <div class="date-and-time">
                                    <input type="text" name="start_timestamp" class="form-control datepicker" data-format="D, dd MM yyyy"
                                        placeholder="date here" value="<?php echo date("D, d M Y", $row['start_timestamp']); ?>" required>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="col-sm-7">
                                <div class="date-and-time">
                                    <input type="text" name="end_timestamp" class="form-control datepicker" data-format="D, dd MM yyyy"
                                        placeholder="date here" value="<?php echo date("D, d M Y", $row['end_timestamp']); ?>" required>
                                </div>
                            </div>
                        </div>
